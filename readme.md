...
- [`StructedClonable`](source/structured-cloneable.d.ts) - Matches any Javascript object that can be used with [`structuredClone()`](https://developer.mozilla.org/en-US/docs/Web/API/structuredClone)
